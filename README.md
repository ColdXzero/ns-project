...
**Term Definition  JDK Java Developing Kit  JSP Java Server Pages  NS  Notification System  API Application Program Interface  REST Representational state transfer**  
